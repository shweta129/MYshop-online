...
import com.niit.onlineshoppingF.util.FileUploadUtility;
import com.niit.onlineshoppingF.validator.ProductValidator;
...
public class ManagementController {
			...
			HttpServletRequest request)
	{
		...
		//if user choose wrong file the esle part
		else{
	...
	public String handleProductActivation(@PathVariable int id)  {
		...
		//activate and deactivate based on the value of the active field
