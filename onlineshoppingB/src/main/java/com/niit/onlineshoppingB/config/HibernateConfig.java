package com.niit.onlineshoppingB.config;
...
@Configuration
@ComponentScan("com.niit.onlineshoppingB.config")
...

{
   ...
   public LocalSessionFactoryBean getSessionFactory(DataSource dataSource)
   {
	   ...
	   sessionBuilder.setPackagesToScan(new String[] {"com.niit.onlineshoppingB.dto"});
